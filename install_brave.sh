...
proot-distro login debian --user $varname --shared-tmp -- env DISPLAY=:1.0 sudo wget https://brave-browser-apt-release.s3.brave.com/brave-browser-archive-keyring.gpg
