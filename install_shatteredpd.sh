...
proot-distro login debian --user $varname --shared-tmp -- env DISPLAY=:1.0 sudo -S apt install openjdk-17-jre -y
proot-distro login debian --user $varname --shared-tmp -- env DISPLAY=:1.0 sudo -S apt -f install 
