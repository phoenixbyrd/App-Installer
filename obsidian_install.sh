...
declare -A APP_CONFIG=(
    [url]="https://github.com/obsidianmd/obsidian-releases/releases/download/v1.3.5/Obsidian-1.3.5-arm64.AppImage"
    [name]="obsidian"
    [icon]="obsidian"
    [category]="Office;"
    ...
    [custom_binary]=""
    [description]="A private and flexible note‑taking app that adapts to the way you think."
)
