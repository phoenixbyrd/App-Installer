...
declare -A APP_CONFIG=(
	[url]="https://github.com/diasurgical/devilutionX/releases/download/1.5.0/devilutionx-linux-aarch64.tar.xz"
	[name]="devilutionx"
	[icon]="Diablo"
	[category]="Game"
	[dependencies]="libsdl2-image-2.0-0 libsodium23"
	[description]="DevilutionX is a source port of Diablo"
)
