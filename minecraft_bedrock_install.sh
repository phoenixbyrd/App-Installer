...
declare -A APP_CONFIG=(
    [url]="https://github.com/minecraft-linux/appimage-builder/releases/download/v1.1.1-802/Minecraft_Bedrock_Launcher-bookworm-arm64-v1.1.1.802.AppImage"
    [name]="minecraft"
    [icon]="minecraft"
    [category]="Game;"
    [dependencies]=""
    [extra_flags]="" #--no-sandbox for electron apps
    [custom_binary]="/opt/minecraft/AppRun"
...
Exec=prun GALLIUM_DRIVER=virpipe $final_binary ${APP_CONFIG[extra_flags]}
