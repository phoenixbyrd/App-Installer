...
proot-distro login debian --user $varname --shared-tmp -- env DISPLAY=:1.0 sudo apt install mesa-utils libopenal1 -y
...
proot-distro login debian --user $varname --shared-tmp -- env DISPLAY=:1.0 sudo apt install ./prismlauncher_7.2-1_arm64.deb
